...
def print_TFrecordimage_tf2fashion(path_to_file):
    ...
    for i, parsed_record in enumerate(parsed_dataset.take(3)):   # each is a dict
        ...
        cv2.imwrite('/home/zwang/Downloads/{}_{}_{}.png'.format(range_oftfrecord,i, "label_sparse"), de_label)

        label_dense = parsed_record['image/segmentation/class/encoded_dense']
        de_label_dense = tf.image.decode_png(label_dense).numpy()
        cv2.imwrite('/home/zwang/Downloads/{}_{}_{}.png'.format(range_oftfrecord,i, "label_dense"), de_label_dense)

if __name__ == '__main__':
    tf.enable_eager_execution()
    TFPATH_RANGE10_VAL = "/mrtstorage/users/zwang/pcd_mapper_pastonly/polar_pastrange10/val/val-00000-of-00021.tfrecord"
    TFPATH_RANGE10_TRAIN = "/mrtstorage/users/zwang/pcd_mapper_pastonly/polar_pastrange10/train/train-00056-of-00096.tfrecord"
    ...
    print_TFrecordimage_tf2fashion(TFPATH_RANGE10_TRAIN)
    pass